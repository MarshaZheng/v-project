...
export const constantRoutes = [{
    ...
    },
    {
        ...
        children: [{
            ...
            meta: { title: 'old节点相似性探索', icon: 'user' }
        }]
    },
    {
        path: '/group',
        ...
        children: [{
            ...
            meta: { title: 'old欺诈团伙探索', icon: 'user' }
        }]
    },
    {
        path: '/path',
